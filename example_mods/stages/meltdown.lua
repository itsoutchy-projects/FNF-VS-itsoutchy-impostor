...
function onCreate()
    ...
    makeLuaSprite('MOOGU_bg6', 'red/polusrocks', -500, -800);
    ...
    makeAnimatedLuaSprite('foreboopers', 'red/boppers_meltdown', -900, -20);
    addAnimationByPrefix("foreboopers", "idle", "BoppersMeltdown", 24, true);
    addLuaSprite("foreboopers", true);
    playAnim("foreboopers", "idle", false, false, 0);
